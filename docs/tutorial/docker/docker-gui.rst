...
The docker setup files and tools can be found under `Open3d/util/docker/open3d-xvfb <https://github.com/intel-isl/Open3D/tree/master/util/docker/open3d-xvfb>`_.
