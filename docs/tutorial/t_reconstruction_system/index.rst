...
.. note::
   The tutorials for tensor-based offline reconstruction system. Simultaneous localization and calibration (SLAC), and shape from shading (SfS) tutorials as mentioned in [Dong2021]_ are under construction. At current, please refer to :ref:`reconstruction_system` for the legacy versions.
