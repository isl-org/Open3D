...
By convention we use ``3.0 / 512`` as the voxel resolution. This spatial resolution is equivalent to representing a ``3m x 3m x 3m`` room with a dense ``512 x 512 x 512`` voxel grid.
