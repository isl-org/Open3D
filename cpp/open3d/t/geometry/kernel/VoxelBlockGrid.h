...
void GetVoxelCoordinatesAndFlattenedIndicesSYCL(const core::Tensor& buf_indices,
                                                const core::Tensor& block_keys,
                                                core::Tensor& voxel_coords,
                                                core::Tensor& flattened_indices,
                                                index_t block_resolution,
...
template <typename input_depth_t,
          ...
          typename weight_t,
          typename color_t>
void IntegrateSYCL(const core::Tensor& depth,
                   const core::Tensor& color,
                   const core::Tensor& block_indices,
                   const core::Tensor& block_keys,
                   TensorMap& block_value_map,
...
void EstimateRangeSYCL(const core::Tensor& block_keys,
                       core::Tensor& range_minmax_map,
                       const core::Tensor& intrinsics,
                       const core::Tensor& extrinsics,
                       int h,
...
template <typename tsdf_t, typename weight_t, typename color_t>
void RayCastSYCL(std::shared_ptr<core::HashMap>& hashmap,
                 const TensorMap& block_value_map,
                 const core::Tensor& range_map,
                 TensorMap& renderings_map,
                 const core::Tensor& intrinsic,
...
template <typename tsdf_t, typename weight_t, typename color_t>
void ExtractPointCloudSYCL(const core::Tensor& block_indices,
                           const core::Tensor& nb_block_indices,
                           const core::Tensor& nb_block_masks,
                           const core::Tensor& block_keys,
                           const TensorMap& block_value_map,
...
template <typename tsdf_t, typename weight_t, typename color_t>
void ExtractTriangleMeshSYCL(const core::Tensor& block_indices,
                             const core::Tensor& inv_block_indices,
                             const core::Tensor& nb_block_indices,
                             const core::Tensor& nb_block_masks,
                             const core::Tensor& block_keys,
