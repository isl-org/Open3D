...
template void IntegrateSYCL<uint16_t, uint8_t, float, uint16_t, uint16_t>(
        FN_ARGUMENTS);
template void IntegrateSYCL<uint16_t, uint8_t, float, float, float>(
        FN_ARGUMENTS);
template void IntegrateSYCL<float, float, float, uint16_t, uint16_t>(
        FN_ARGUMENTS);
...
template void RayCastSYCL<float, uint16_t, uint16_t>(FN_ARGUMENTS);
template void RayCastSYCL<float, float, float>(FN_ARGUMENTS);
...
template void ExtractPointCloudSYCL<float, uint16_t, uint16_t>(FN_ARGUMENTS);
template void ExtractPointCloudSYCL<float, float, float>(FN_ARGUMENTS);
...
template void ExtractTriangleMeshSYCL<float, uint16_t, uint16_t>(FN_ARGUMENTS);
template void ExtractTriangleMeshSYCL<float, float, float>(FN_ARGUMENTS);
