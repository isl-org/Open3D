...
#include "open3d/ml/impl/sparse_conv/SparseConvTransposeBackpropFilterSYCL.h"
...
void SparseConvTransposeBackpropFilterSYCL(
    ...
    RunSYCLWithTempMemory(
            ...
            [&](void* temp_ptr, size_t& temp_size, size_t& max_temp_size) {
                SparseConvTransposeBackpropFilterSYCL<TFeat, TOut, TIndex,
                                                      TKernelIndex>(
                        queue, temp_ptr, temp_size, max_temp_size,
                        texture_alignment, filter_backprop.data_ptr<TOut>(),
                        filter_dims, neighbors_row_splits.size(0) - 1,
...
#define INSTANTIATE(TFeat, TOut, TIndex, TKernelIndex)                         \
    template void                                                              \
    SparseConvTransposeBackpropFilterSYCL<TFeat, TOut, TIndex, TKernelIndex>(  \
