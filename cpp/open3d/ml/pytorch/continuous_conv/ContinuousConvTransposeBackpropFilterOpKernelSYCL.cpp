...
#include "open3d/ml/impl/continuous_conv/ContinuousConvTransposeBackpropFilterSYCL.h"
#include "open3d/ml/pytorch/TorchHelper.h"

using namespace open3d::ml::impl;

template <class TFeat, class TOut, class TReal, class TIndex>
void ContinuousConvTransposeBackpropFilterSYCL(
    ...
    RunSYCLWithTempMemory(
            ...
            [&](void* temp_ptr, size_t& temp_size, size_t& max_temp_size) {
                CConvTransposeBackpropFilterSYCL<TFeat, TOut, TReal, TIndex>(
...
#define INSTANTIATE(TFeat, TOut, TReal, TIndex)                                \
    template void                                                              \
    ContinuousConvTransposeBackpropFilterSYCL<TFeat, TOut, TReal, TIndex>(     \
