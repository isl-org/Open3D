...
#include "open3d/ml/impl/misc/VoxelizeSYCL.h"
...
#define CASE(NDIM)                                                        \
    case NDIM: {                                                          \
        VoxelizeSYCL<T, NDIM>(                                            \
                queue, points.size(0), points.data_ptr<T>(),              \
                row_splits.size(0) - 1, row_splits.data_ptr<int64_t>(),   \
...
#define INSTANTIATE(T)                                                       \
    template void VoxelizeSYCLDispatch<T>(                                   \
