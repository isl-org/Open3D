...
// SYCL port of ContinuousConvTransposeBackpropFilter.cuh. See
// ContinuousConvSYCL.h's file header for the general porting notes. Uses
// FillColumnTransposeSYCL, the <ColumnMajor, RowMajor> GEMM layout combo
// (same as ContinuousConvBackpropFilter), and MultiplyAndCopyColumnsSYCL for
...
/// SYCL version of CConvTransposeBackpropFilterCUDA. See
/// ContinuousConvTransposeBackpropFilter.cuh for the full parameter
/// documentation; semantics are identical.
template <class TFeat, class TOut, class TReal, class TIndex>
void CConvTransposeBackpropFilterSYCL(sycl::queue& queue,
                                      void* temp,
                                      size_t& temp_size,
    ...
    // the analogous comment in SparseConvTransposeBackpropFilterSYCL.h).
