...
// SYCL port of ContinuousConvTranspose.cuh. See ContinuousConvSYCL.h's file
// header for the general porting notes. Uses FillColumnTransposeSYCL, the
// <ColumnMajor, ColumnMajor> GEMM layout combo (same as the forward op), and
// MultiplyColumnsSYCL for the optional output-importance scaling.
#pragma once
...
/// SYCL version of CConvTransposeComputeFeaturesCUDA. See
/// ContinuousConvTranspose.cuh for the full parameter documentation;
/// semantics are identical.
template <class TFeat, class TOut, class TReal, class TIndex>
void CConvTransposeComputeFeaturesSYCL(
        sycl::queue& queue,
        void* temp,
        size_t& temp_size,
