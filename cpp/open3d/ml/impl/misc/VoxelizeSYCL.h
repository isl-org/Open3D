...
// Kernels here use core::ParallelFor (int64_t lambda), not nd_item kernels;
// [[intel::kernel_args_restrict]] would need to live in ParallelFor.h to
// apply globally. ComputeStartIdxSYCL may alias points_count with
// unique_hashes_count at some call sites — audit before adding no-alias hints.
