...
// SYCL port of SparseConvTranspose.cuh. See SparseConvSYCL.h's file header
// for general porting notes. Uses <ColumnMajor, ColumnMajor> GEMM (same as
// forward SparseConv) and the shared MultiplyColumnsSYCL kernel for the
// optional out_importance scaling.
#pragma once
...
/// SYCL version of SparseConvTransposeComputeFeaturesCUDA. See
/// SparseConvTranspose.cuh for the full parameter documentation; semantics
/// are identical.
template <class TFeat, class TOut, class TIndex, class TKernelIndex>
void SparseConvTransposeComputeFeaturesSYCL(
        sycl::queue& queue,
        void* temp,
        size_t& temp_size,
