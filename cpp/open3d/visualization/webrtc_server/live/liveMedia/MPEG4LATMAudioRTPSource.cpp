...
MPEG4LATMAudioRTPSource* MPEG4LATMAudioRTPSource::createNew(
...
Boolean MPEG4LATMAudioRTPSource ::processSpecialHeader(
    ...
    do {
        ...
        do {
            ...
            audioSpecificConfig[i++] =
                    (remainingBit << 7) | ((nextByte & 0xFE) >> 1);
...
unsigned char* parseStreamMuxConfigStr(char const* configStr,
    ...
    if (!parseStreamMuxConfigStr(configStr, audioMuxVersion,
                                 ...
                                 numProgram, numLayer, audioSpecificConfig,
