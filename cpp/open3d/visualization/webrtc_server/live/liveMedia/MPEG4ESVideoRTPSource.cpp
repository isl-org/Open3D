...
MPEG4ESVideoRTPSource* MPEG4ESVideoRTPSource::createNew(
...
Boolean MPEG4ESVideoRTPSource ::processSpecialHeader(
...
char const* MPEG4ESVideoRTPSource::MIMEtype() const { return "video/MP4V-ES"; }
