...
H263plusVideoRTPSource* H263plusVideoRTPSource::createNew(
...
H263plusVideoRTPSource ::H263plusVideoRTPSource(UsageEnvironment& env,
    ...
    : MultiFramedRTPSource(env, RTPgs, rtpPayloadFormat, rtpTimestampFrequency),
      fNumSpecialHeaders(0),
      fSpecialHeaderBytesLength(0) {}

H263plusVideoRTPSource::~H263plusVideoRTPSource() {}

Boolean H263plusVideoRTPSource ::processSpecialHeader(
