...
SimpleRTPSink::SimpleRTPSink(UsageEnvironment& env,
                             Groupsock* RTPgs,
...
SimpleRTPSink::~SimpleRTPSink() { delete[](char*) fSDPMediaTypeString; }

SimpleRTPSink* SimpleRTPSink::createNew(UsageEnvironment& env,
                                        Groupsock* RTPgs,
                                        unsigned char rtpPayloadFormat,
                                        unsigned rtpTimestampFrequency,
                                        char const* sdpMediaTypeString,
...
char const* SimpleRTPSink::sdpMediaType() const { return fSDPMediaTypeString; }
