...
MP3ADUTranscoder::~MP3ADUTranscoder() { delete[] fOrigADU; }
...
void MP3ADUTranscoder::doGetNextFrame() {
    fInputSource->getNextFrame(fOrigADU, MAX_MP3_FRAME_SIZE, afterGettingFrame,
...
void MP3ADUTranscoder::afterGettingFrame1(unsigned numBytesRead,
                                          ...
                                          unsigned durationInMicroseconds) {
    fNumTruncatedBytes =
            numTruncatedBytes;  // but can we handle this being >0? #####
    fPresentationTime = presentationTime;
    fDurationInMicroseconds = durationInMicroseconds;
    fFrameSize = TranscodeMP3ADU(fOrigADU, numBytesRead, fOutBitrate, fTo,
                                 fMaxSize, fAvailableBytesForBackpointer);
