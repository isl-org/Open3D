...
H263plusVideoRTPSink* H263plusVideoRTPSink::createNew(
...
void H263plusVideoRTPSink ::doSpecialFrameHandling(
    ...
    if (fragmentationOffset == 0) {
        ...
        if (numBytesInFrame < 2) {
            envir() << "H263plusVideoRTPSink::doSpecialFrameHandling(): bad "
                       "frame size "
                    << numBytesInFrame << "\n";
            return;
        }
