...
char const* MPEG4VideoFileServerMediaSubsession::getAuxSDPLine(
...
FramedSource* MPEG4VideoFileServerMediaSubsession ::createNewStreamSource(
...
RTPSink* MPEG4VideoFileServerMediaSubsession ::createNewRTPSink(
