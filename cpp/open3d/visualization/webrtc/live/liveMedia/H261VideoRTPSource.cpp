...
H261VideoRTPSource* H261VideoRTPSource::createNew(
...
H261VideoRTPSource ::H261VideoRTPSource(UsageEnvironment& env,
                                        Groupsock* RTPgs,
                                        unsigned char rtpPayloadFormat,
                                        unsigned rtpTimestampFrequency)
...
Boolean H261VideoRTPSource ::processSpecialHeader(
