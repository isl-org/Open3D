...
MP3ADURTPSource* MP3ADURTPSource::createNew(UsageEnvironment& env,
                                            Groupsock* RTPgs,
...
MP3ADURTPSource::MP3ADURTPSource(UsageEnvironment& env,
                                 Groupsock* RTPgs,
                                 unsigned char rtpPayloadFormat,
                                 unsigned rtpTimestampFrequency)
...
char const* MP3ADURTPSource::MIMEtype() const { return "audio/MPA-ROBUST"; }
