...
void pybind_trianglemesh_definitions(py::module &m) {
    ...
    trianglemesh
            ...
            .def("filter_sharpen", &TriangleMesh::FilterSharpen,
                 ...
                 py::arg_v("filter_scope", MeshBase::FilterScope::All, "FilterScope.All"))
            ...
            .def("filter_smooth_taubin", &TriangleMesh::FilterSmoothTaubin,
                 ...
                 "number_of_iterations"_a = 1, "lambda_filter"_a = 0.5,
                 "mu"_a = -0.53, py::arg_v("filter_scope", MeshBase::FilterScope::All, "FilterScope.All"))
            ...
            .def("simplify_vertex_clustering",
                 ...
                 "voxel_size"_a,
                 py::arg_v("contraction", MeshBase::SimplificationContraction::Average,"SimplificationContraction.Average"))
