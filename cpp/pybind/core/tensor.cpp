...
Example:
    ...
    tensor.def("gram", &Tensor::Gram,
               "Computes the Gram matrix of a given <=2D tensor. 1D tensors of shape {n} are expanded to 2D by reshaping them to {1, n}.");
    tensor.def("row_gram", &Tensor::RowGram,
               "Computes the Row Gram matrix of a given <=2D tensor. 1D tensors of shape {n} are expanded to 2D by reshaping them to {1, n}.");
