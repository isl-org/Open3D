...
void pybind_gui_events_declarations(py::module& m_gui) {
    py::native_enum<MouseButton>(
            m_gui, "MouseButton", "enum.IntFlag", "Mouse button identifiers")
        ...
        .export_values()
        .finalize();
    py::native_enum<KeyModifier>(
            m_gui, "KeyModifier", "enum.IntFlag", "Key modifier identifiers")
    ...
    py::native_enum<MouseEvent::Type>(
            mouse_event, "Type", "enum.Enum", "Mouse event type.")
        ...
        .export_values()
        .finalize();
    py::native_enum<KeyName>(
            m_gui, "KeyName", "enum.IntEnum", "Names of keys. Used by KeyEvent.key")
    ...
    py::native_enum<KeyEvent::Type>(
            key_event, "Type", "enum.Enum", "Key event type.")
