...
SET(CONFIG_OPTIONS   -DBUILD_CUDA_LIB:BOOL=OFF -DBUILD_C_BINDINGS:BOOL=OFF -DBUILD_MATLAB_BINDINGS:BOOL=OFF -DBUILD_PYTHON_BINDINGS:BOOL=OFF -DBUILD_DOCS:BOOL=OFF)
...
IF (NOT ${${LIB_NAME_UPPER}_FOUND})
    ...
    FILE(GLOB _LIBS "${LIB_DIR}/*${BUILD_TARGET}*")
