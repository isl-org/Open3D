...
if __name__ == "__main__":
    ...
    pcds = [];
    trajectory = o3d.io.read_pinhole_camera_trajectory("../../TestData/RGBD/trajectory.log")
    ...
    for i in range(5):
        im1 = o3d.io.read_image("../../TestData/RGBD/depth/{:05d}.png".format(i))
        im2 = o3d.io.read_image("../../TestData/RGBD/color/{:05d}.jpg".format(i))
        im = o3d.geometry.create_rgbd_image_from_color_and_depth(im2, im1, 1000.0, 5.0, False)
        pcd = o3d.geometry.create_point_cloud_from_rgbd_image(im,
