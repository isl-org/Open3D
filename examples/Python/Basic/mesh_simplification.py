...
if __name__ == "__main__":
    ...
    for mesh in mesh_generator():
        ...
        mesh.vertex_colors = o3d.utility.Vector3dVector(np.random.uniform(0,1, size=(n_verts,3)))
        ...
        mesh_smp = o3d.geometry.simplify_vertex_clustering(mesh, voxel_size=voxel_size,
        ...
        mesh_smp = o3d.geometry.simplify_quadric_decimation(mesh,
