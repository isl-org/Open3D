...
if __name__ == "__main__":
    ...
    mesh_cubic = create_mesh_cubic(width = 1.0, height = 1.0, depth = 1.0)
    mesh_cubic.compute_vertex_normals()
    mesh_cubic.paint_uniform_color([0.9, 0.1, 0.1])
    ...
    draw_geometries([mesh_cubic, mesh_sphere, mesh_cylinder, mesh_frame])
