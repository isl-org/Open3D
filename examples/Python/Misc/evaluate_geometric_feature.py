...
if __name__ == "__main__":
    pcd_target = o3d.io.read_point_cloud("../../TestData/o3d.registration.Feature/cloud_bin_0.pcd")
    pcd_source = o3d.io.read_point_cloud("../../TestData/o3d.registration.Feature/cloud_bin_1.pcd")
    feature_target = o3d.io.read_feature("../../TestData/o3d.registration.Feature/cloud_bin_0.fpfh.bin")
    feature_source = o3d.io.read_feature("../../TestData/o3d.registration.Feature/cloud_bin_1.fpfh.bin")
