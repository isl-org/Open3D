...
copy(_ExecutionPolicy&& __exec, _ForwardIterator1 __first, _ForwardIterator1 __last, _ForwardIterator2 __result)
{
    ...
    return __internal::__pattern_walk2_brick(
        std::forward<_ExecutionPolicy>(__exec), __first, __last, __result, __internal::__brick_copy<_ExecutionPolicy>{},
        __internal::__is_parallelization_preferred<_ExecutionPolicy, _ForwardIterator1, _ForwardIterator2>(__exec));
}
...
copy_n(_ExecutionPolicy&& __exec, _ForwardIterator1 __first, _Size __n, _ForwardIterator2 __result)
{
    ...
    return __internal::__pattern_walk2_brick_n(
        std::forward<_ExecutionPolicy>(__exec), __first, __n, __result, __internal::__brick_copy_n<_ExecutionPolicy>{},
        __internal::__is_parallelization_preferred<_ExecutionPolicy, _ForwardIterator1, _ForwardIterator2>(__exec));
}
          ...
          _ForwardIterator __result, _BinaryOperation __op)
{
    ...
    return __internal::__pattern_walk3(
        ...
        __internal::__is_vectorization_preferred<_ExecutionPolicy, _ForwardIterator1, _ForwardIterator2, _ForwardIterator>(
            __exec),
        __exec.__allow_parallel());
}
...
{
    std::sort(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
{
    std::stable_sort(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
move(_ExecutionPolicy&& __exec, _ForwardIterator1 __first, _ForwardIterator1 __last, _ForwardIterator2 __d_first)
{
    ...
    return __internal::__pattern_walk2_brick(
        std::forward<_ExecutionPolicy>(__exec), __first, __last, __d_first,
        __internal::__brick_move<_ExecutionPolicy>{},
        __internal::__is_parallelization_preferred<_ExecutionPolicy, _ForwardIterator1, _ForwardIterator2>(__exec));
}
...
{
    std::partial_sort(std::forward<_ExecutionPolicy>(__exec), __first, __middle, __last, __pstl::__internal::__pstl_less());
}
...
{
    return is_sorted_until(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
{
    return std::is_sorted(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
{
    std::inplace_merge(std::forward<_ExecutionPolicy>(__exec), __first, __middle, __last, __pstl::__internal::__pstl_less());
}
...
{
    return std::is_heap_until(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
{
    return std::is_heap(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
{
    return std::min_element(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
max_element(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last)
{
    ...
    return std::min_element(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                            __pstl::__internal::__reorder_pred<__pstl::__internal::__pstl_less>(__pstl::__internal::__pstl_less()));
}
...
{
    return std::minmax_element(std::forward<_ExecutionPolicy>(__exec), __first, __last, __pstl::__internal::__pstl_less());
}
...
nth_element(_ExecutionPolicy&& __exec, _RandomAccessIterator __first, _RandomAccessIterator __nth,
            _RandomAccessIterator __last)
{
    std::nth_element(std::forward<_ExecutionPolicy>(__exec), __first, __nth, __last, __pstl::__internal::__pstl_less());
}
