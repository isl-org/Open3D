...
apply_one "$PATCH_DIR/0002-build-enable_safe_libstdcxx.patch" "$WEBRTC_SRC/build_overrides"
apply_one "$PATCH_DIR/0003-src-fix-nullptr_t-with-libstdcxx.patch" "$WEBRTC_SRC"
apply_one "$PATCH_DIR/0004-src-gcc-suppress-port-interface-network.patch" "$WEBRTC_SRC"
apply_one "$PATCH_DIR/0005-call-payload_type_picker-gcc-flat_tree.patch" "$WEBRTC_SRC"
apply_one "$PATCH_DIR/0006-build-win-dynamic-crt.patch" "$WEBRTC_SRC/build"
