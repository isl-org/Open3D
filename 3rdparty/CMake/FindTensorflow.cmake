...
if(NOT Tensorflow_FOUND)
  ...
  execute_process(
    COMMAND
      ${PYTHON_EXECUTABLE} "-c"
      "from __future__ import print_function; import tensorflow as tf; print(tf.sysconfig.get_include(), end='')"
    OUTPUT_VARIABLE Tensorflow_INCLUDE_DIR)
  execute_process(
    COMMAND
      ${PYTHON_EXECUTABLE} "-c"
      "from __future__ import print_function; import tensorflow as tf; print(tf.sysconfig.get_lib(), end='')"
  ...
  execute_process(
    COMMAND
      ${PYTHON_EXECUTABLE} "-c"
      "from __future__ import print_function; import tensorflow as tf; defs = [ x[2:] for x in tf.sysconfig.get_compile_flags() if x.startswith('-D')]; print(';'.join(defs), end='')"
...
if(${Tensorflow_DEFINITIONS} MATCHES "_GLIBCXX_USE_CXX11_ABI=([01])")
  if((GLIBCXX_USE_CXX11_ABI AND NOT CMAKE_MATCH_1) OR (NOT GLIBCXX_USE_CXX11_ABI
                                                       AND CMAKE_MATCH_1))
    message(
      FATAL_ERROR
        "_GLIBCXX_USE_CXX11_ABI mismatch: Open3D ${GLIBCXX_USE_CXX11_ABI} vs Tensorflow ${CMAKE_MATCH_1}"
    )
  endif()
endif()
