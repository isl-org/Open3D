...
if (FILAMENT_PRECOMPILED_ROOT)
    ...
    get_filename_component(FILAMENT_NAME ${DOWNLOAD_URL_PRIMARY} NAME)
    set_local_or_remote_url(FILAMENT_URL
        LOCAL_URL "${OPEN3D_THIRD_PARTY_DOWNLOAD_DIR}/${FILAMENT_NAME}"
        REMOTE_URLS ${DOWNLOAD_URL_PRIMARY} ${DOWNLOAD_URL_FALLBACK}
        )
