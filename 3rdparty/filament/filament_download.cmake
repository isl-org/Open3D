...
if (FILAMENT_PRECOMPILED_ROOT)
    ...
    if(WIN32)
        set(DOWNLOAD_URL_PRIMARY "https://github.com/google/filament/releases/download/v1.9.4/filament-v1.9.4-windows.tgz")
    elseif(APPLE)
        set(DOWNLOAD_URL_PRIMARY "https://github.com/google/filament/releases/download/v1.9.4/filament-v1.9.4-mac.tgz")
        ...
        if(${glibc_version} VERSION_LESS "2.31")
            set(DOWNLOAD_URL_PRIMARY
                "https://github.com/google/filament/releases/download/v1.9.4/filament-v1.9.4-linux.tgz")
