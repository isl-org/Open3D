...
if(USE_BLAS)
    ...
    if(UNIX)
        target_compile_options(3rdparty_mkl INTERFACE "$<$<COMPILE_LANGUAGE:CXX>:-DMKL_ILP64;-m64>")
    ...
    elseif(MSVC)
        target_compile_options(3rdparty_mkl INTERFACE "$<$<COMPILE_LANGUAGE:CXX>:/DMKL_ILP64>")
    endif()
