        ...
        if(UNIX AND NOT APPLE)
            ...
            if (NOT CLANG_LIBDIR)
                ...
                foreach(llvm_lib_dir in ${ubuntu_default_llvm_lib_dirs})
                    ...
                    find_library(CPP_LIBRARY    NAMES libc++.a    PATHS ${llvm_lib_dir} NO_DEFAULT_PATH)
                    find_library(CPPABI_LIBRARY NAMES libc++abi.a PATHS ${llvm_lib_dir} NO_DEFAULT_PATH)
            ...
            if (CLANG_LIBDIR)
                ...
                message(FATAL_ERROR "Cannot find matchig libc++ and libc++abi libraries with version >=7.")
            endif()
            find_library(CPP_LIBRARY    NAMES libc++.a    PATHS ${CLANG_LIBDIR} REQUIRED NO_DEFAULT_PATH)
            find_library(CPPABI_LIBRARY NAMES libc++abi.a PATHS ${CLANG_LIBDIR} REQUIRED NO_DEFAULT_PATH)
