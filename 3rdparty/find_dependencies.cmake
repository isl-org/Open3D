...
if(BUILD_GUI)
    ...
    if(UNIX AND NOT APPLE)
        if(${BUILD_PYTHON_MODULE} STREQUAL "WHEEL")
            set(LIBCPP_NAME libc++.a)    # Static libraries
            set(LIBCPPABI_NAME libc++abi.a)
        else()
            set(LIBCPP_NAME c++)         # Dynamic libraries
            set(LIBCPPABI_NAME c++abi)
        endif()
        find_library(CPPABI_LIBRARY ${LIBCPPABI_NAME} PATH_SUFFIXES llvm-7/lib llvm-8/lib
        ...
        if(CPPABI_LIBRARY) # Ensure that libstdc++ gets linked first
            ...
            find_library(CPP_LIBRARY ${LIBCPP_NAME} PATH ${CPP_LIBDIR}
                NO_DEFAULT_PATH)
