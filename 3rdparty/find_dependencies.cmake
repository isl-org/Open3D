...
if(USE_PREINSTALLED_EIGEN3)
    ...
    if(TARGET Eigen3::Eigen)
        ...
        set(USE_PREINSTALLED_EIGEN3 OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_EIGEN3)
...
# Flann
if(USE_PREINSTALLED_FLANN)
    pkg_config_3rdparty_library(3rdparty_flann flann)
endif()
if(NOT USE_PREINSTALLED_FLANN OR NOT 3rdparty_flann_FOUND)
...
if(USE_PREINSTALLED_GLEW)
    ...
    if(TARGET GLEW::GLEW)
        ...
        if(3rdparty_glew_FOUND)
            ...
            set(USE_PREINSTALLED_GLEW OFF)
        endif()
    endif()
endif()
if(NOT USE_PREINSTALLED_GLEW)
...
if(USE_PREINSTALLED_GLFW)
    ...
    if(TARGET glfw)
        ...
        if(3rdparty_glfw3_FOUND)
            ...
            set(USE_PREINSTALLED_GLFW OFF)
        endif()
    endif()
endif()
if(NOT USE_PREINSTALLED_GLFW)
...
# TurboJPEG
if(USE_PREINSTALLED_JPEG AND BUILD_AZURE_KINECT)
    ...
    if(3rdparty_turbojpeg_FOUND)
        ...
        set(USE_PREINSTALLED_JPEG OFF)
    endif()
endif()

# JPEG
if(USE_PREINSTALLED_JPEG)
    find_package(JPEG)
    if(TARGET JPEG::JPEG)
...
if(USE_PREINSTALLED_LIBLZF)
    ...
    if(TARGET liblzf::liblzf)
        ...
        set(USE_PREINSTALLED_LIBLZF OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_LIBLZF)
...
if(USE_PREINSTALLED_PNG)
    ...
    if(TARGET PNG::PNG)
        ...
        set(USE_PREINSTALLED_PNG OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_PNG)
...
if(USE_PREINSTALLED_TINYGLTF)
    ...
    if(TARGET TinyGLTF::TinyGLTF)
        ...
        set(USE_PREINSTALLED_TINYGLTF OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_TINYGLTF)
...
# tinyobjloader
if(USE_PREINSTALLED_TINYOBJLOADER)
    ...
    if(TARGET tinyobjloader::tinyobjloader)
        ...
        set(USE_PREINSTALLED_TINYOBJLOADER OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_TINYOBJLOADER)
...
if(USE_PREINSTALLED_QHULL)
    ...
    if(TARGET Qhull::qhullcpp)
        ...
        set(USE_PREINSTALLED_QHULL OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_QHULL)
...
if(USE_PREINSTALLED_FMT)
    ...
    elseif(TARGET fmt::fmt)
        ...
        set(USE_PREINSTALLED_FMT OFF)
    endif()
endif()
if(NOT USE_PREINSTALLED_FMT)
...
# Pybind11
if(USE_PREINSTALLED_PYBIND11)
    find_package(pybind11)
endif()
if (NOT USE_PREINSTALLED_PYBIND11 OR NOT TARGET pybind11::module)
    set(USE_PREINSTALLED_PYBIND11 OFF)
...
# Googletest
if (BUILD_UNIT_TESTS)
    if(USE_PREINSTALLED_GOOGLETEST)
        ...
        if(gtest_INCLUDE_DIRS AND gtest_LIBRARY AND gmock_INCLUDE_DIRS AND gmock_LIBRARY)
            ...
            set(USE_PREINSTALLED_GOOGLETEST OFF)
        endif()
    endif()
    if(NOT USE_PREINSTALLED_GOOGLETEST)
...
if(ENABLE_GUI)
    if(USE_PREINSTALLED_IMGUI)
        ...
        if(TARGET ImGui::ImGui)
            ...
            set(USE_PREINSTALLED_IMGUI OFF)
        endif()
    endif()
    if(NOT USE_PREINSTALLED_IMGUI)
