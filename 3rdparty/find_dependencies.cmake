...
if(USE_SYSTEM_MSGPACK)
    ...
    if(PkgConfig_FOUND)
        ...
        if( msgpack_FOUND )
            add_library(3rdparty_msgpack INTERFACE)
            foreach(incl IN LISTS msgpack_INCLUDE_DIRS)
                target_include_directories(3rdparty_msgpack INTERFACE ${${incl}})
            endforeach()
            foreach(lib IN LISTS msgpack_LIBRARIES)
                target_link_libraries(3rdparty_msgpack INTERFACE ${${lib}})
            endforeach()
            add_library(Open3D::3rdparty_msgpack ALIAS 3rdparty_msgpack)
        else()
           set(USE_SYSTEM_MSGPACK OFF)
        endif()
    else()
