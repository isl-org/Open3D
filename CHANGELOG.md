## Main
-   Add an optional low-memory DBSCAN mode for legacy and tensor point clouds (`precompute_neighbors=False`), and avoid duplicate expansion entries in both modes (PR #7572).
