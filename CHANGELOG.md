...
-   Fix vcpkg CMake packaging by adding `BUILD_TOOLS` / `BUILD_APPS` switches, avoiding `fmt/std.h` under NVCC, and exporting CUDA imported targets instead of absolute toolkit paths (PR #7551).
