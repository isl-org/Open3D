...
# - open3d_ispc_target_sources_ISPC_TARGET_OBJECTS(...)
#
...
# Internal helper function.
function(open3d_ensure_generated_property target files)
...
# - Must be calling in the same directory where the target has been created.
...
# open3d_ispc_target_sources_ISPC_TARGET_OBJECTS(<target>
#     PRIVATE <dep1> [<dep2>...]
# )
#
# Simulates the call
...
# )
#
# for manually compiled ISPC sources files generated by open3d_ispc_target_sources(...).
#
# This is required for object libraries <dep1> [<dep2>...] to ensure correct linking
# since the respective $<TARGET_OBJECTS:...> generator expression does not include
# manually generated object files.
function(open3d_ispc_target_sources_ISPC_TARGET_OBJECTS target)
    cmake_parse_arguments(PARSE_ARGV 1 ARG "" "" "PRIVATE")
    ...
    if(NOT BUILD_ISPC_MODULE OR (NOT ISPC_FORCE_LEGACY AND (CMAKE_GENERATOR MATCHES "Make" OR CMAKE_GENERATOR MATCHES "Ninja")))
        ...
        foreach (dep IN LISTS ARG_PRIVATE)
            ...
            if (DEP_GENERATED_OBJECT_FILES)
                target_sources(${target} PRIVATE
                    ${DEP_GENERATED_OBJECT_FILES}
                )
                open3d_ensure_generated_property(${target} "${DEP_GENERATED_OBJECT_FILES}")
            endif()
        endforeach()
    endif()
endfunction()
